 ...
 * so a run is safe to repeat. Tables come first and indexes last, because an index may name a column a
 * step adds. A step that rebuilds a table from a fixed column list drops any column added before it, so
 * a later column goes after the rebuild.
 *
